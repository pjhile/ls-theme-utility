...
?>
  ...
  <h3 class="style-2 block left">Shipping Information <img src="<?= root_url('/') ?>resources/images/colors/<?= $site_settings->theme->color ?>/icon-copy.png" /> <a href="javascript:;" onclick="return $('#billing_info').sendRequest('shopprofile:on_updateBilling', {
      onSuccess: function() {
